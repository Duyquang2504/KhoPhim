...
export default function PlayListFilm() {
  ...
  console.log("🚀 ~ PlayListFilm ~ type:", type);

  return (
    <div className="flex flex-col gap-8 w-[70%] rounded-tr-3xl px-8 rounded-tl-[50px]  bg-gradient-to-b from-[#191b24f5] via-[#191b24] to-[#191b24]">
